      ...
      <header id="header">
        <nav>
          ...
          <ul>
            ...
            <li><Link to="#portfolio_section">Courses</Link></li>
        ...
        <img src={menuIcon} className="menu" onClick={() => {/* Add sideMenu function if needed */}} alt="menu" />
      </nav>
